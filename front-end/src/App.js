...
function App() {
  ...
  if(process.env.NODE_ENV != 'production') console.warn("Please ensure you are running the local intelliJ Server on port 8080, as you are not running the production build!")
